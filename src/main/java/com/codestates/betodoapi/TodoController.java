...
public class TodoController {
    ...
    public TodoController(TodoService todoService, TodoMapper mapper, @Value("${root-url:/}") String rootUrl) {
    ...
    public ResponseEntity<TodoResponseDto> postTodo(@Valid @RequestBody TodoPostDto postDto) {
        ...
        return new ResponseEntity<>(mapper.todoToTodoResponseDto(todo, rootUrl + todo.getId()),
                HttpStatus.CREATED
        );
    }
